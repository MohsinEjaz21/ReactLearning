...
export const UserForm = ({ props: { userAddFormMeta, handleAddEditSubmit, addFormRef, addEditFooterActions, apiResponse } }) => {
    ...
    <>
      <Form form={addFormRef} onFinish={handleAddEditSubmit} >
        <Modal title="Add User" visible={isAddModalOpen} footer={addEditFooterActions}>
          <AntdDatePicker {...userAddFormMeta.dob} />
          <AntdSwitch {...userAddFormMeta.isMarried} />
          <AntdRadio {...userAddFormMeta.role} options={apiResponse.roles} />
          <AntdMultiSelect {...userAddFormMeta.role} options={apiResponse.roles}
